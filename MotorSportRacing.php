...
<!--BANNER SECTION-->
<section class="bannerSection mt-0 bannerPageSection" style="background-image:url('images/jon-tyson-gIVzDR6JRWc-unsplash.jpg') ;">
    <div class="innerBannerPageSection">
      <div class="bannerContent">
          <h2><strong >MotorSportTraining Department</strong></h2>
          <h6><strong>Home/Departments/MotorSportTraining</strong></h6>
      </div>
     </div>
  </section>
  ...
  <section class="contentSection bg-light">
    <center>
        <div class="row contentSectionRow">
            <div class="col-md-4">
                  <img src="images/nick-fewings-RgJqQPZupgM-unsplash.jpg" class="img-fliud img-thumbnail" style="width: 100%; height: 300px;">
              </div>

              <div class="col-md-8 mt-5">
                <h3 class="ml-4">
                    <strong>MotorSportTraining</strong>
